...
// CHALLENGE CARD
// ============================================
function ChallengeCard({ challenge, onDelete }: { challenge: DirectionChallenge; onDelete?: (id: string) => void }) {
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="p-3 bg-gray-50 rounded-lg text-center">
              ...
              <p className="text-xs text-gray-500">Concessions</p>
          ...
          {challenge.status === "active" && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                {completedCount} concession{completedCount > 1 ? "s" : ""} ont atteint l&apos;objectif
              </p>
            </div>
          )}
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Challenges entre les concessions de votre marque</p>
        </div>
          ...
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">
              {searchQuery
                ...
                : "Lancez un challenge inter-concessions pour stimuler la performance !"}
            </p>
            <Link href="/marque/challenges/new">
